...
const createSlider = () => {
  ...
  let removeNegativeValue=Math.abs(duration);
    ...
    sliders.forEach(slide => {
      ...
      <h1>Beautiful & Responsive !</h1>
      <p>Features an easy to use interface, an elegant design and powerful payment integrations, enabling you to achieve a high conversion rate.
      The multi-store platform is 100% responsive and works perfectly on any device.</p>
      <a href='index.html'><button>Click for order</button></a>
      `;
